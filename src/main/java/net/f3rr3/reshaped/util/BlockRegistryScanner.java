...
public class BlockRegistryScanner {
    ...
    private static void processBlock(Block block, BlockMatrix matrix, boolean shouldRefresh) {
        ...
        if (isIgnoredForMatrix(block)) return;
    ...
    private static boolean isIgnoredForMatrix(Block block) {
        ...
        // Copycat-style blocks often expose oak planks as internal/default state,
        // which causes false grouping into vanilla plank columns.
