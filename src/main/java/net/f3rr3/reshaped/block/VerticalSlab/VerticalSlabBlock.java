...
public class VerticalSlabBlock extends ReshapedBlock {
    ...
    public BlockState getPlacementState(ItemPlacementContext ctx) {
        ...
        if (playerFacing.getAxis() == Direction.Axis.Z) {
            nearHalf = playerFacing == Direction.NORTH ? localHit.z > 0.5 : localHit.z < 0.5;
        } else {
            nearHalf = playerFacing == Direction.EAST ? localHit.x < 0.5 : localHit.x > 0.5;
        }

        Direction facing = nearHalf ? playerFacing : playerFacing.getOpposite();
