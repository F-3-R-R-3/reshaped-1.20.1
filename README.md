...
Includes vertical slabs, vertical stairs, steps, corner blocks, and more.  
Additional block types, such as panel blocks, are planned for the future.

![Some possible block combinations](https://cdn.modrinth.com/data/cached_images/8feefc95304d2ef2a2fffe259fdf22c011ac6641.png)

Below is an example showing all generated blocks when another mod is installed (Create mod in this case):
...
### Mixable blocks
Almost all block shapes are mixable, allowing the use of multiple materials within a single block.
